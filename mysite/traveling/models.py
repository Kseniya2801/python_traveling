...
class Traveling(models.Model):
    ...
    cat = models.ForeignKey(Category, on_delete=models.PROTECT, verbose_name='Категории') #запретим удалять категории, на которые есть ссылки из traveling; класс categoty дб выше по расположению этого классы
